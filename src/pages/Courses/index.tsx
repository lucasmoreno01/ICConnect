    ...
    <>
      ...
      <div className="container-courses">
        <section className="top-box">
          <div className="graduacao-box">
            ...
            <button className="box-btn">
              <img className="seta-btn" src={arrow_down} alt="arrow_down" />
            </button>
          </div>
        ...
        <div className="semestre">
          ...
          <button
            className="box-btn btn"
            data-bs-toggle="collapse"
            data-bs-target="#card"
          >
            <img className="seta-btn" src={arrow_down} alt="arrow" />
          </button>
        </div>


        <div className="courses collapse show" id="card">
          <Link to="/courses/courses/mata02" className="course-link">
          ...
          <Link to="/courses/courses/mata37" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/courses/mata39" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/courses/mata42" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/courses/mata68" className="course-link">
            <div className="course-card">
        ...
        <div className="courses collapse show" id="card2">
          <Link to="/courses/adme99" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/matc73" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/matc90" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/matc92" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/matd04" className="course-link">
            <div className="course-card">
        ...
        <div className="courses collapse show" id="card3">
          <Link to="/courses/adm001" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/mata07" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/mata55" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/mata58" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/matc94" className="course-link">
            <div className="course-card">
        ...
        <div className="courses collapse show" id="card4">
          <Link to="/courses/leta09" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/mat236" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/mata59" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/mata62" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/matc82" className="course-link">
            <div className="course-card">
        ...
        <div className="courses collapse show" id="card5">
          <Link to="/courses/adm211" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/mata56" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/mata60" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/mata63" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/matc84" className="course-link">
            <div className="course-card">
        ...
        <div className="courses collapse show" id="card6">
          <Link to="/courses/admf01" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/mat220" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/mata76" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/matb09" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/matc89" className="course-link">
            <div className="course-card">
        ...
        <div className="courses collapse show" id="card7">
          <Link to="/courses/mata64" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/matb02" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/matb19" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/matc72" className="course-link">
            <div className="course-card">
          ...
          <Link to="/courses/matc99" className="course-link">
            <div className="course-card">
        ...
        <div className="courses collapse show" id="card9">
          <Link to="/courses/gicc0003" className="course-link">
            <div className="course-card">
              <span className="course-title">GICC0003</span>
              <span className="course-hour">45h</span>
            </div>
            <p className="course-name">
              TCC BACHARELADO SISTEMAS DE INFORMAÇÃO I
            </p>
          </Link>
        </div>
        ...
        <div className="courses collapse show" id="card10">
          <Link to="/courses/gicc0004" className="course-link">
            <div className="course-card">
              <span className="course-title">GICC0004</span>
              <span className="course-hour">120h</span>
            </div>
            <p className="course-name">
              TCC BACHARELADO SISTEMAS DE INFORMAÇÃO II
            </p>
          </Link>
        </div>
      </div>
